...
class YOLO(object):
    ...
    _defaults = {
        "model_path": '/Users/huanghaihun/Documents/wood_yolo3/data/ep190-loss14.823-val_loss16.483.h5',
    ...
    def generate(self, ):
        ...
        with self.myGraph.as_default():
            ...
            self.yolo_model: keras.Model = yolo_body(self.image_input, num_anchors // 3,
                                                     num_classes)  # make sure you know what you freeze
